...
###################################
  MSE= MSE/givendata['n_test'] if givendata['n_test']>0 else 0
  NMSE= MSE/givendata['VARtrain'] if givendata['VARtrain']>0 else 0
...
#    pass
    net['mes']='{:d}({:.3f}s) {:.3e} {:.3e} #ep(time),MSEtr,MSE n{},{} k{} N{} T{},{} seed{} nop{}'.format(net['GlobalTime'],elapsed_time,MSEtr.get(),MSE.get(),givendata['n_train'],givendata['n_test'],net['k'],net['n_cells'],net['T'],net['Tpinv'],net['seed'], net['nop'])
  else:
