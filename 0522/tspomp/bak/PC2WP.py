...
#          for n in range(N):
      #################
          ...
          fn='{}/{}-pPcG.dat'.format(dr,fnB)#  
          df=pd.DataFrame(Qc.reshape((1,-1)))
          df.to_csv(fn,index=False,sep=' ',header=None)
          fn='{}/{}-pPcbG.dat'.format(dr,fnB)#  
          ...
          print('#{}-[rPc|rPcb|rP1|pPc|pPcb|Ppc].dat created'.format(fnB))
