...
cat > ../../result-chaospred/lorenz1e-8T0.025n10000p256m1_gmp/HEns50b20a2.3.dat <<EOF
#50  370.9 228.7 225.7 222.8 0.99804 0.99874 0.99946 30 #mean Hgmax,Hgo0,1,2,E0,1,2: k10N50ns50m2b20a2.3 (ncmax)
60  386.3 238.2 240.1 239.0 0.99742 0.99846 0.99917 30 #mean Hgmax,Hgo0,1,2,E0,1,2: k10N60ns50m2b20a2.3 (ncmax)
70  409.2 249.4 259.3 258.7 0.99739 0.99836 0.99933 30 #mean Hgmax,Hgo0,1,2,E0,1,2: k10N70ns50m2b20a2.3 (ncmax) E0-Max H0max H2max
80  379.5 211.6 208.5 206.0 0.99712 0.99814 0.99911 30 #mean Hgmax,Hgo0,1,2,E0,1,2: k10N80ns50m2b20a2.3 (ncmax)
90  377.9 221.2 222.5 226.9 0.99725 0.99851 0.99921 30 #mean Hgmax,Hgo0,1,2,E0,1,2: k10N90ns50m2b20a2.3 (ncmax)
100 372.3 227.8 228.2 226.1 0.99734 0.99855 0.99923 30 #mean Hgmax,Hgo0,1,2,E0,1,2: k10N100ns50m2b20a2.3 (ncmax)  E02ndMax
110 377.9 221.2 222.5 226.9 0.99725 0.99851 0.99921 30 #mean Hgmax,Hgo0,1,2,E0,1,2: k10N110ns50m2b20a2.3 (ncmax)
EOF
...
###1 Hg vs. N for single and bagging
plot [][180:260] "../../result-chaospred/lorenz1e-8T0.025n10000p256m1_gmp/HEns50b20a2.3.dat" using 1:5 w lp pt 6, "" using 1:4 w lp pt 8, "" using 1:3 w lp pt 10, "../../result-chaospred/lorenz1e-8T0.025n10000p256m1_gmp/HEns50b1.dat" using 1:5 w lp pt 6, "" using 1:4 w lp pt 8, "" using 1:3 w lp pt 10
unset key;set term tgif;set output "Hg-N.obj"
replot
set term x11;set key
### Ent vs Hg for single and bagging
plot "../../result-chaospred/lorenz1e-8T0.025n10000p256m1_gmp/HEns50b20a2.3.dat" using 5:8 w lp pt 6, "" using 4:7 w lp pt 8, "" using 3:6 w lp pt 10, "../../result-chaospred/lorenz1e-8T0.025n10000p256m1_gmp/HEns50b1.dat" using 5:8 w lp pt 6, "" using 4:7 w lp pt 8, "" using 3:6 w lp pt 10
unset key;set term tgif;set output "E-Hg.obj"
replot
set term x11;set key
### Hg vs tp
plot "../../result-chaospred/lorenz1e-8T0.025n10000p256m1_gmp/k10N70ns50m2b20a2.3Hgn.dat" using ($0*100+2000):4 w lp pt 6, "../../result-chaospred/lorenz1e-8T0.025n10000p256m1_gmp/k10N:90ns50Hgn.dat" using ($0*100+2000):4 w lp pt 6
unset key;set term tgif;set output "Hg-tp.obj"
replot;set term x11;set key

### Hg vs tp y-t
!gv ~/sotu/2019/result-chaospred/lorenz1e-8T0.025n10000p256m1_gmp/t0-2000:3300-3800k10N70ns50m2b20a2.3/y_L2.eps&
!gv ~/sotu/2019/result-chaospred/lorenz1e-8T0.025n10000p256m1_gmp/t0-2000:3300-3800k10N:90ns50/y_L2.eps&
