...
#for can2c
dst=../../can2data/Geo1d_${ntrain}_${restest}_${extest}/
mkdir -p $dst
cp tmp/train.csv $dst
cp tmp/test.csv $dst
#
#(2) ensrs.pyによる学習と予測
#(2-1) 使用例
...
100(17.817s) 4.206e-05 6.654e-05 #ep(time),MSEtr,MSE n1990,500 k10 N50 T100,-1 seed10 nop1 t0-2000:2000-2500:1:15H222 predTime0.016s
