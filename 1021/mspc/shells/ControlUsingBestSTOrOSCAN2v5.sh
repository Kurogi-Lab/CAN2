...
#b=1;N=20;a=0;mspcDir=~/sotuicc/2012a/mspc/;CAN2Str=OS;it1=10;it2=6;it3=15;it4=12;mailAddress="youname@kurolab2.cntl.kyutech.ac.jp";ky=4;ku=4;doPlot="yesno";itblock=2;nohup sh ./ControlUsingBestSTOrOSCAN2v5.sh $b $N $a $mspcDir $CAN2Str $it1 $it2 $it3 $it4 $mailAddress $ky $ku $doPlot $itblock 1> ./ControlUsingBest_${CAN2Str}_CAN2.result.b=$b.a=$a.N=${N}.ky=${ky}.ku=${ku}.itblock=$itblock.txt 2> ./ControlUsingBest_${CAN2Str}_CAN2.debugResult.b=$b.a=$a.N=${N}.ky=${ky}.ku=${ku}.itblock=$itblock.txt &

#use best ST CAN2 to control
#b=1;N=20;a=0;mspcDir=~/sotuicc/2012a/mspc/;CAN2Str=ST;it1=10;it2=6;it3=15;it4=12;mailAddress="youname@kurolab2.cntl.kyutech.ac.jp";ky=4;ku=4;doPlot="yesno";itblock=2;nohup sh ./ControlUsingBestSTOrOSCAN2v5.sh $b $N $a $mspcDir $CAN2Str $it1 $it2 $it3 $it4 $mailAddress $ky $ku $doPlot $itblock 1> ./ControlUsingBest_${CAN2Str}_CAN2.result.b=$b.a=$a.N=${N}.ky=${ky}.ku=${ku}.itblock=$itblock.txt 2> ./ControlUsingBest_${CAN2Str}_CAN2.debugResult.b=$b.a=$a.N=${N}.ky=${ky}.ku=${ku}.itblock=$itblock.txt &
#---------------------------------------実行方法　2----------------------------------------
