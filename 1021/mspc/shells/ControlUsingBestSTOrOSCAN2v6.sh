...
#b=50;N=20;a=0.1;mspcDir=~/sotuicc/2012a/mspc/;CAN2Str=OS;it1=61;it2=66;it3=61;it4=20;mailAddress="ko@kurolab2.cntl.kyutech.ac.jp";ky=6;ku=6;doPlot="yesno";itblock=5;nohup sh ./ControlUsingBestSTOrOSCAN2v6.sh $b $N $a $mspcDir $CAN2Str $it1 $it2 $it3 $it4 $mailAddress $ky $ku $doPlot $itblock 1> ./ControlUsingBest_${CAN2Str}_CAN2.result.b=$b.a=$a.N=${N}.ky=${ky}.ku=${ku}.itblock=$itblock.txt 2> ./ControlUsingBest_${CAN2Str}_CAN2.debugResult.b=$b.a=$a.N=${N}.ky=${ky}.ku=${ku}.itblock=$itblock.txt &

#use best ST CAN2 to control
#b=50;N=20;a=0.1;mspcDir=~/sotuicc/2012b/mspc/;CAN2Str=ST;it1=60;it2=72;it3=22;it4=71;mailAddress="ko@kurolab2.cntl.kyutech.ac.jp";ky=6;ku=6;doPlot="yesno";itblock=5;nohup sh ./ControlUsingBestSTOrOSCAN2v6.sh $b $N $a $mspcDir $CAN2Str $it1 $it2 $it3 $it4 $mailAddress $ky $ku $doPlot $itblock 1> ./ControlUsingBest_${CAN2Str}_CAN2.result.b=$b.a=$a.N=${N}.ky=${ky}.ku=${ku}.itblock=$itblock.txt 2> ./ControlUsingBest_${CAN2Str}_CAN2.debugResult.b=$b.a=$a.N=${N}.ky=${ky}.ku=${ku}.itblock=$itblock.txt &
#---------------------------------------実行方法　2----------------------------------------
...
#use best OS CAN2 to control
#b=1;N=20;a=0;mspcDir=~/sotuicc/2012a/mspc/;CAN2Str=OS;it1=10;it2=6;it3=15;it4=12;mailAddress="youname@kurolab2.cntl.kyutech.ac.jp";ky=4;ku=4;doPlot="yesno";itblock=2;nohup sh ./ControlUsingBestSTOrOSCAN2v6.sh $b $N $a $mspcDir $CAN2Str $it1 $it2 $it3 $it4 $mailAddress $ky $ku $doPlot $itblock 1> ./ControlUsingBest_${CAN2Str}_CAN2.result.b=$b.a=$a.N=${N}.ky=${ky}.ku=${ku}.itblock=$itblock.txt 2>&1 &

#use best ST CAN2 to control
#b=1;N=20;a=0;mspcDir=~/sotuicc/2012a/mspc/;CAN2Str=ST;it1=10;it2=6;it3=15;it4=12;mailAddress="youname@kurolab2.cntl.kyutech.ac.jp";ky=4;ku=4;doPlot="yesno";itblock=2;nohup sh ./ControlUsingBestSTOrOSCAN2v6.sh $b $N $a $mspcDir $CAN2Str $it1 $it2 $it3 $it4 $mailAddress $ky $ku $doPlot $itblock 1> ./ControlUsingBest_${CAN2Str}_CAN2.result.b=$b.a=$a.N=${N}.ky=${ky}.ku=${ku}.itblock=$itblock.txt 2>&1 &
#-------------------------------------------------------------------------------
...
parameterString="b=${b}.a=${a}.N=${N}.ky=${ky}.ku=${ku}.itblock=${itblock}.it1=${it1}.it2=${it2}.it3=${it3}.it4=${it4}"
...
then
	...
	echo -e `ps aux|grep "ControlUsingBestSTOrOSCAN2.*""${mspcDir}"|grep -v "grep"`|mail -s "Error,this mspc dir have be used! change the mspc dir! ""b=$b.a=$a.N=${N}.ky=${ky}.ku=${ku}.itblock=$itblock" $mailAddress
	exit 1
fi
