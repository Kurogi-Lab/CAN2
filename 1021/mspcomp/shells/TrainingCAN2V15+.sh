#
#modified by kuro
#ThisFile=./TrainingCAN2V15+.sh;b=1;N=20;a=0;mspcDir=~/sotu/2012/mspc/;mailAddress="";ky=5;ku=5;controlTimes=100;crRange="2 10";cmRange="10 100";doPlot="no";kyoyou=0.1;itblock=2;id=b${b}.a${a}.N${N}.ky${ky}.ku${ku}.controlTimes${controlTimes}.crRange${crRange// /_}.cmRange${cmRange// /_}.kyoyou$kyoyou.itblock$itblock;nohup bash $ThisFile $b $N $a $mspcDir $mailAddress $ky $ku $controlTimes "$crRange" "$cmRange" $doPlot $kyoyou $itblock 1> ./TrainingCAN2.stdout.${id}.txt 2> ./TrainingCAN2.error.${id}.txt &
