...
#  if nRX>0:  fnrX=args.dir+'/speaker-verif-result-X-R{}{}.dat'.format(args.R,args.FD)
  ...
  if method[0][:4]=='MFCC':
    ...
    FDextr='LPCSE1k{}l{}ns{}N{}b{}a{}R{}'.format(k,l,ns,N,b,_mbas[2],args.R) #    FDext='{}F{}x{}'.format(FD,nr,na)#20210616
  else:
...
#            import pdb;pdb.set_trace(); #for debug
      ...
      if i_f == n_train-1 or i_f == n_Fall-1:
        ...
        ret='{:.3f} {:.3f} {:.3f} {:.3f} {:.3f} = {} {} {} {} {} {} {} {} {} {} {} #TP,TN,FP,FN,ER=.#n,m,R,RX,mbas,N'.format(TPR,TNR,FPR,FNR,ERR,TP,TN,FP,FN,ER,n,m,args.R,args.RX,args.mbas,N)
