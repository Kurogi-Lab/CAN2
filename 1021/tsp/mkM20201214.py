...
#  parser.add_argument('-ow', default=1, type=int,   help='Overwite files if ow=1, omit otherwise.')
  ...
  parser.add_argument('-mp_th', default=0.0, type=float,   help='mean power')
...
##
              ...
              if os.path.exists(fnout) and args.ow[1] == '1':
                print('#{} exists: Omit calc because ow=="?1"'.format(fnout))
                continue
#              k=args.k;N=args.N;t0=0;t1=400
              if args.l <= 0:
                k=args.k;N=args.N;t0=0;t1=400 #t1=400 will be changed to the number of all data by poledistribv2-.c
                ...
                cmd='python lpcspectrumenvelope.py -yin {} -k {} -l {} -mp_th {} -fout {} -nDisp {}'.format(dmsm,args.k,args.l,args.mp_th,fnout,nDisp)
