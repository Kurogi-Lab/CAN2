...
#12345678901234567890
    fptrain.close()
    fptest.close()
    mylib.myshell('cp {}.dat {}/{}.dat'.format(fntrain,dr,fntrain))
    print('#saved {}/{}.dat',dr,fntrain)
#    mylib.myshell('cp {}.dat {}/{}.dat'.format(fntest,dr,fntest))


#    import pdb;pdb.set_trace(); #for debug
    k=len(x)
###trainig and test of oob
    cmd='ensrs {}.dat {} {}-{} k:{} ib:0:0:0:0 y:-1:1:-1:1 x:0:0:0:1 DISP:0 nop:1 bg:/dev/null'.format(fntrain,args.mbas,args.N,args.N,k)
