...
#
################### 
# (0-1) execute 'make' first
# (0-2) 次のhtopとkonsoleをインストールしておく
#sudo snap install htop #CPU使用率モニタ（テキストベースのシステムモニタ）
#sudo apt install konsole # /etc/apt/souces.listのnvidiaが生きているところをコメントアウト
###################
cd ../tspomp
#(0) 
export ddc=../../chaos.data fbc=lorenz1e-8T0.025n10000p256m1_gmp d00=../../result-chaospred;export d0=$d00/$fbc;mkdir -p $d0
#export ddc=~/data fbc=lorenz1e-8T0.025n10000p256m1_gmp d00=../../result-chaospred;export d0=$d00/$fbc;mkdir -p $d0 #for kurogi
export L=2 N=50 ns=50 k=10 m=2 b=1 a=1.0 mc=0 TP0S=`seq 2000 100 4900`;nohup loocv-bat.sh& #can2m/tspomp
export L=2 N=100 ns=50 k=10 m=2 b=1 a=1.0 mc=0 TP0S=`seq 2000 100 4900`;nohup loocv-bat.sh& #can2m/tspomp
...
head -3 nohup.out
echo "\n<<<nohup.out(tail -5)>>>"
cat nohup.out|grep -e python -e ensrs -e can2 |tail -5
#tail -5 nohup.out
#echo "\n<<<Number of files created>>>"
#echo "\`ls \${dr}/*\${fnkw12}*.dat 2>/dev/null |wc -l \` *-${fnkw12}.dat files ($nf:necessary) in \\\$dr=$dr \`date +%H:%M:%S\`"
EOF
#gnome-terminal --geometry 140x22+0+0 -- bash -c "watch -n 1 sh cmd-mon.sh"&
konsole -p 'TerminalColumns=200' -p 'TerminalRows=22' -e "watch -n 1 sh cmd-mon.sh"&
#d0=../../result-chaospred/lorenz1e-8T0.025n10000p256m1_gmp
export L=2 N=50 ns=50 k=10 m=2 b=1 a=1.0 mc=0 TP0S=`seq 2000 100 4900`;nohup loocv-bat.sh& #can2m/tspomp
#Elapsed Time=0:13:37 @susanoo 0:17:11 @VB@win10
# 298.7 179.5 178.9 187.9 0.99421 0.99675 0.99797 30 k10N50ns50m2b1a1.0 (ncmax)#mean Hgmax,Hgo0,1,2,E0,1,2
export L=2 N=50 ns=50 k=10 m=2 b=20 a=2.3 mc=0 TP0S=`seq 2000 100 4900`;nohup loocv-bat.sh& #can2m1/tspomp
# 343.9 206.5 206.7 211.1 0.99807 0.99875 0.99948 30 k10N50ns50m2b20a2.3 (ncmax)#mean Hgmax,Hgo0,1,2,E0,1,2
#lapsed Time=1:57:56  @susanoo



################### 
# (1) This file is /home/kuro/sotu/2019/can2m/tsp/readmecan2mchaos.txt
export dsingle=/home/kuro/sotu/2019/can2m/tsp
export dbagging=/home/kuro/sotu/2019/can2m/tspomp
################### 
2021052014:00
###################
(1) kmeans2_kuro.pyで
  LOOH[j] /= (nLOOH-1)
 を条件なしにしていて,nLOOH=1のときnanになっていたので
　if nLOOH>1:
 　 LOOH[j] /= (nLOOH-1)
 に変更した。 
################### 
...
###################
#../tspomp/ でsingleを実験
export L=2 N=40 ns=50 k=10 m=2 b=1 a=1.0 mc=0 TP0S=`seq 2000 100 4900`;nohup loocv-bat.sh& #can2m/tspomp
export L=2 N=50 ns=50 k=10 m=2 b=1 a=1.0 mc=0 TP0S=`seq 2000 100 4900`;nohup loocv-bat.sh& #can2m/tspomp
export L=2 N=60 ns=50 k=10 m=2 b=1 a=1.0 mc=0 TP0S=`seq 2000 100 4900`;nohup loocv-bat.sh& #can2m/tspomp
export L=2 N=120 ns=50 k=10 m=2 b=20 a=2.3 mc=0 TP0S=`seq 2000 100 4900`;nohup loocv-bat.sh& #can2m/tspomp

cat > ../../result-chaospred/lorenz1e-8T0.025n10000p256m1_gmp/HEns50m2b1a1.0.dat <<EOF
40  287.9 169.6 165.9 171.7 0.99283 0.99675 0.99789 30 k10N40ns50m2b1a1.0 (ncmax) #mean Hgmax,Hgo0,1,2,E0,1,2
50  298.7 179.5 178.9 187.9 0.99421 0.99675 0.99797 30 k10N50ns50m2b1a1.0 (ncmax) #mean Hgmax,Hgo0,1,2,E0,1,2
60  295.0 178.5 185.6 189.3 0.99518 0.99763 0.99866 30 k10N60ns50m2b1a1.0 (ncmax) #mean Hgmax,Hgo0,1,2,E0,1,2
70  303.8 173.5 173.4 181.8 0.99456 0.99674 0.99809 30 k10N70ns50m2b1a1.0 (ncmax) #mean Hgmax,Hgo0,1,2,E0,1,2
80  321.5 173.8 175.4 185.0 0.99487 0.99735 0.99833 30 k10N80ns50m2b1a1.0 (ncmax) #mean Hgmax,Hgo0,1,2,E0,1,2
90  309.7 177.2 177.0 169.7 0.9949 0.99691 0.99844  30 k10N90ns50m2b1a1.0 (ncmax) #mean Hgmax,Hgo0,1,2,E0,1,2
100 298.3 180.8 180.6 178.1 0.9938 0.9965 0.99803   30 k10N100ns50m2b1a1.0 (ncmax) #mean Hgmax,Hgo0,1,2,E0,1,2
110 310.8 191.9 192.8 188.5 0.99363 0.99649 0.99752 30 k10N110ns50m2b1a1.0 (ncmax)#mean Hgmax,Hgo0,1,2,E0,1,2
120 316.2 188.5 187.0 187.0 0.99379 0.99596 0.99744 30 k10N120ns50m2b1a1.0 (ncmax)#mean Hgmax,Hgo0,1,2,E0,1,2
130 310.6 172.1 168.5 175.6 0.99326 0.99611 0.99741 30 k10N130ns50m2b1a1.0 (ncmax)#mean Hgmax,Hgo0,1,2,E0,1,2
140 296.2 177.9 173.3 171.9 0.99336 0.99633 0.99757 30 k10N140ns50m2b1a1.0 (ncmax)#mean Hgmax,Hgo0,1,2,E0,1,2
EOF

#error 
export d0=../../result-chaospred/lorenz1e-8T0.025n10000p256m1_gmp
export D=k${k}N${N}ns${ns}m${m}b${b}a${a}
export fHgo=$d0/${D}Hgn.dat key="(ncmax" 
cat /dev/null > tmp/tmp.out
for tp in `seq 3500 100 4900` ; do
echo "tp=$tp"
python kmeans2_kuro.py -d1 ${d0}/t0-2000:${tp}-$((tp+500))${D} -fnyp tspSth.dat -fnyg yg.dat -K 2 -L $L -Lt 0 -m 1 -Ey 15 -hh 30 -DISP 0 >>tmp/tmp.out
done 

350 172 172 172 0.99572 0.99888 0.99936 #Hgmax,(ncmax32)HgoL0,1,2,Entr0,1,2 #t0-2000:3400-3900k10N100ns50m2b1a1.0

Elapsed Time=2:9:10 (2020年  6月 22日 月曜日 15:48:25 JST - 2020年  6月 22日 月曜日 17:57:35 JST)
...
export L=2 N=120 ns=50 k=10 m=2 b=20 a=2.3 mc=0 TP0S=`seq 2000 100 4900`;nohup loocv-bat.sh& #can2m/tspomp
!!!Elapsed Time=21:32:37 (2020年  6月 25日 木曜日 14:15:53 JST - 2020年  6月 26日 金曜日 11:48:30 JST)
...
120 313.8 192.9 196.1 190.7 0.99774 0.99872 0.9994  30 k10N120ns50m2b20a2.3 (ncmax)#mean Hgmax,Hgo0,1,2,E0,1,2
EOF
