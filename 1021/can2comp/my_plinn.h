...
typedef struct {
  ...
  int DISP;
  int nop;
  char *fnp; //file name of prediction of test
  char *fnn; //net file name
  char *fnis; //is file name
  char *fnp0; //file name of prediction of train 
  char *fnm; //mse file name
  char *fntt; //train+test file name
} NET;
